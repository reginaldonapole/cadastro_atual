...
public class PrimaryController {
    ...
    void salvar(ActionEvent event) throws SQLException {
        ...
        prodDao.gravarNoBanco(txt_nome.getText(),txt_fornecedor.getText(), txt_marca.getText(), txt_categoria.getText(), txt_ultcompra.getText(), txt_compra.getText(), txt_venda.getText(), txt_qntd.getText() );
